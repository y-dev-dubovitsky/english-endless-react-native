...
export const PAST_PERFECT: TenseInterface = {
  ...
  verbs: [
    ...
    [
      ...
      { 'already completed by noon': 'уже завершили к полудню' },
      { 'already submitted by six PM': 'уже подали к шести вечера' },
      { 'already reviewed by the judge': 'уже проверили судья' },
      { 'already approved by the committee': 'уже одобрили комитетом' },
      {
        'already planned by the end of the day':
          'уже запланировали к концу дня',
      },
      { 'already organized by the team': 'уже организовали командой' },
      { 'already executed by the deadline': 'уже выполнили к сроку' },
      {
        'already agreed upon by both parties':
          'уже согласовали обеими сторонами',
      },
      {
        'already published by the publisher': 'уже опубликовали издательством',
      },
      { 'already distributed by the supplier': 'уже распределили поставщиком' },
      { 'already finalized by the manager': 'уже утвердили менеджером' },
    ],
  ],
  html: `${template}`,
};
